...
comma-spacing, array-callback-return */

const expect = require('chai').expect;
var circularBuffer = require('../../server/models/bob.js').circularBuffer;
var bufferEmptyException = require('../../server/models/circular-buffer').bufferEmptyException;
var bufferFullException = require('../../server/models/circular-buffer').bufferFullException;
